...
const Gallery = () => {
  ...
  const images: GalleryImage[] = [
    {
      src: galery1,
      alt: "Ahora Baila - Moment 1",
      title: "Passion in Motion",
    },
    {
      src: galery2,
      alt: "Ahora Baila - Moment 2",
      title: "Movement and Rhythm",
    },
    { src: galery3, alt: "Ahora Baila - Moment 3", title: "Class in Action" },
    {
      src: galery4,
      alt: "Ahora Baila - Moment 4",
      ...
      <section className="py-24 bg-neutral-900 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 reveal">
            ...
            <h2 className="font-serif text-4xl md:text-5xl font-bold mt-2 text-white mb-4">
              Our Community
            </h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
              Captured moments of passion, rhythm, and community that make Ahora
              Baila a special place.
            </p>
          </div>
      ...
      {selectedImage && (
        ...
        >
          ...
          >
            ...
            />
            <h3 className="text-center text-white font-serif text-2xl mt-4">
              {selectedImage.title}
            </h3>
          </div>
        </div>
