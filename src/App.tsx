        ...
        <div className="max-w-7xl mx-auto px-4 text-center reveal">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <a
              ...
              className="flex items-center gap-3 px-8 py-4 bg-red-700 text-white font-bold rounded shadow-lg shadow-red-950/20 hover:bg-red-600 transition-all transform hover:-translate-y-1 uppercase tracking-widest text-xs"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 px-8 py-4 bg-yellow-600 text-black font-bold rounded shadow-lg shadow-yellow-900/20 hover:bg-yellow-500 transition-all transform hover:-translate-y-1 uppercase tracking-widest text-xs"
            >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="flex flex-col justify-center items-center bg-neutral-900/50 p-8 border border-white/5 rounded-lg text-center reveal">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full py-4 bg-red-700 text-white font-bold uppercase tracking-widest rounded shadow-lg shadow-red-950/40 hover:bg-red-600 transition-all transform hover:-translate-y-1 flex items-center justify-center gap-3"
                >
