...
const App = () => {
  ...
  return (
    <div className="bg-neutral-950 text-slate-50 font-sans antialiased selection:bg-red-700 selection:text-white overflow-x-hidden">
      ...
      {/* Navigation */}
      <nav className={`fixed w-full z-50 transition-all duration-300 border-b border-white/10 ${scrolled ? 'bg-neutral-950/95 shadow-lg backdrop-blur-md' : 'bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex space-x-8 items-center">
              {['Home', 'The All-Star', 'Classes', 'Membership', 'Studio'].map((item) => (
                <a 
                  key={item}
              ...
              <a href="#contact" className="px-6 py-2 border border-yellow-600 text-yellow-600 hover:bg-yellow-600 hover:text-black transition-all duration-300 text-sm uppercase tracking-widest font-bold">
                Book Class
              </a>
            </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-neutral-900 border-b border-white/10 animate-fadeIn">
            <div className="px-4 pt-2 pb-8 space-y-4 flex flex-col items-center">
              {['Home', 'The All-Star', 'Classes', 'Membership', 'Contact'].map((item) => (
                <a 
                  key={item}
                  href={`#${item.toLowerCase().replace(' ', '-')}`}
      ...
      <header id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center bg-no-repeat bg-fixed transform scale-105" 
             style={{ backgroundImage: "url('https://images.unsplash.com/photo-1516651029879-1996715f019b?q=80&w=1920&auto=format&fit=crop')" }}>
        </div>
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-16 animate-fade-in-up">
          <p className="text-yellow-600 tracking-[0.3em] uppercase text-sm md:text-base mb-4">US Salsa Academy</p>
          <h1 className="font-serif text-5xl md:text-7xl lg:text-8xl font-bold leading-tight mb-6 drop-shadow-2xl">
            Feel the Rhythm <br /> 
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-400 italic">Ignite the Soul</span>
          </h1>
          <p className="text-gray-300 text-lg md:text-xl max-w-2xl mx-auto mb-10 font-light drop-shadow-md">
            Experience world-class salsa instruction led by <strong className="text-white">All-Star Rachel Ortiz</strong>. 
            Where technique meets passion on the dance floor.
          </p>
          <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
            <a href="#membership" className="px-8 py-4 bg-red-700 text-white font-bold uppercase tracking-widest hover:bg-red-600 transition-all shadow-lg shadow-red-900/50 transform hover:-translate-y-1">
              View Plans
            </a>
            <a href="#about" className="px-8 py-4 border border-white text-white font-bold uppercase tracking-widest hover:bg-white hover:text-black transition-all">
              Meet Rachel
            </a>
          </div>
        </div>
      ...
      {/* About Rachel */}
      <section id="the-all-star" className="py-24 bg-neutral-950 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div className="relative reveal">
                    ...
                    <div className="absolute bottom-8 left-8 bg-black/80 backdrop-blur px-6 py-4 border-l-4 border-red-600">
                        <p className="text-2xl font-serif italic text-white">Rachel Ortiz</p>
                        <p className="text-yellow-600 text-xs tracking-widest uppercase">Founder & Head Instructor</p>
                    </div>
                </div>
                <div className="reveal">
                    <div className="flex items-center gap-4 mb-6">
                        <span className="h-px w-12 bg-red-600"></span>
                        <span className="text-red-600 uppercase tracking-widest text-sm font-bold">The Visionary</span>
                    </div>
                    <h2 className="font-serif text-4xl md:text-5xl font-bold mb-6 text-white">
                        From the <span className="text-yellow-600">All-Star</span> Stage <br />to Your Studio
                    </h2>
                    <p className="text-gray-400 mb-6 leading-relaxed">
                        With over 15 years of professional experience competing on global stages, Rachel Ortiz brings the precision of a competitor and the soul of a true Salsera to her students.
                    </p>
                    <p className="text-gray-400 mb-8 leading-relaxed">
                        After retiring from the All-Star circuit, Rachel founded <em>Baila Conmigo</em> in the heart of the USA with a simple mission: to empower students to find their own style through the art of Salsa.
                    </p>
                    <div className="grid grid-cols-2 gap-6 mb-8">
                        ...
                        <div>
                            <p className="text-3xl font-serif text-white">200+</p> {/* Fixed: changed class="text-3xl" to className="text-3xl" */}
                            <p className="text-xs text-gray-500 uppercase tracking-widest mt-1">Students Taught</p>
                        </div>
                    </div>
                </div>
            </div>
      ...
      <section id="membership" className="py-24 bg-neutral-950 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16 reveal">
            <span className="text-red-600 uppercase tracking-widest text-sm font-bold">Invest in Yourself</span>
            <h2 className="font-serif text-4xl md:text-5xl font-bold mt-2 text-white">Class Pricing</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="bg-neutral-900 border border-white/10 p-8 hover:border-white/30 transition-all reveal group">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Single Class</h3>
              ...
              <ul className="space-y-3 mb-8 text-gray-400 text-sm">
                <li className="flex gap-2"><Check className="w-4 h-4 text-red-600" /> Pay as you go</li>
                <li className="flex gap-2"><Check className="w-4 h-4 text-red-600" /> Access to Level 1 or 2</li>
                <li className="flex gap-2"><Check className="w-4 h-4 text-red-600" /> Valid for 30 days</li>
              </ul>
              <button onClick={() => { setBookingType('group'); window.location.href='#contact'; }} className="w-full py-3 border border-white/20 text-white uppercase tracking-widest text-xs font-bold hover:bg-white hover:text-black transition-all">Select</button>
            </div>
            ...
            <div className="bg-neutral-800 border-2 border-red-600/50 p-8 relative transform md:-translate-y-4 shadow-2xl shadow-red-900/20 reveal">
              <div className="absolute top-0 right-0 bg-red-600 text-white text-[10px] font-bold px-3 py-1 uppercase tracking-widest">Best Value</div>
              ...
              <ul className="space-y-3 mb-8 text-gray-300 text-sm">
                <li className="flex gap-2"><Check className="w-4 h-4 text-yellow-500" /> Unlimited Group Classes</li>
                <li className="flex gap-2"><Check className="w-4 h-4 text-yellow-500" /> Priority Booking</li>
                <li className="flex gap-2"><Check className="w-4 h-4 text-yellow-500" /> Access to Socials</li>
                <li className="flex gap-2"><Check className="w-4 h-4 text-yellow-500" /> Cancel anytime</li>
              </ul>
              <button onClick={() => { setBookingType('group'); window.location.href='#contact'; }} className="w-full py-3 bg-red-600 text-white uppercase tracking-widest text-xs font-bold hover:bg-red-700 transition-all">Join Family</button>
            </div>
            ...
            <div className="bg-neutral-900 border border-white/10 p-8 hover:border-yellow-600/50 transition-all reveal group">
              ...
              <div className="flex items-baseline mb-6">
                <span className="text-xl font-serif text-white italic">Custom Quote</span>
              </div>
              <ul className="space-y-3 mb-8 text-gray-400 text-sm">
                <li className="flex gap-2"><Check className="w-4 h-4 text-yellow-600" /> 1-on-1 with Rachel</li>
                <li className="flex gap-2"><Check className="w-4 h-4 text-yellow-600" /> Personalized choreography</li>
                <li className="flex gap-2"><Check className="w-4 h-4 text-yellow-600" /> Competition prep</li>
              </ul>
              <button onClick={() => { setBookingType('private'); window.location.href='#contact'; }} className="w-full py-3 border border-yellow-600 text-yellow-600 uppercase tracking-widest text-xs font-bold hover:bg-yellow-600 hover:text-black transition-all">Request Quote</button>
            </div>
      ...
      <div className="h-40 bg-fixed bg-center bg-cover flex items-center justify-center relative" style={{backgroundImage: "url('https://images.unsplash.com/photo-1515234520935-7734898495a9?q=80&w=1920&auto=format&fit=crop')"}}>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="bg-black border border-white/10 p-8 md:p-12 shadow-2xl reveal">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div>
                <span className="text-red-600 uppercase tracking-widest text-sm font-bold">Join the Family</span>
                <h2 className="font-serif text-4xl text-white mb-6">Start Your Journey</h2>
                <p className="text-gray-400 mb-8">Ready to step onto the floor? Fill out the form to schedule your first class or consultation with Rachel.</p>
              ...
              <form className="space-y-4">
                ...
                <div className="flex mb-6 bg-neutral-900 p-1 rounded border border-white/10">
                  <button 
                    ...
                    className={`flex-1 py-2 text-xs uppercase font-bold tracking-widest transition-all ${bookingType === 'group' ? 'bg-red-700 text-white shadow' : 'text-gray-500 hover:text-white'}`}
                  >
                    Group Class
                  </button>
                  <button 
                    ...
                    className={`flex-1 py-2 text-xs uppercase font-bold tracking-widest transition-all ${bookingType === 'private' ? 'bg-yellow-600 text-black shadow' : 'text-gray-500 hover:text-white'}`}
                  >
                    Private Quote
                  </button>
                </div>
                ...
                <div>
                  ...
                  <input type="text" className="w-full bg-neutral-900 border border-neutral-700 text-white px-4 py-3 focus:outline-none focus:border-red-600 transition-colors" placeholder="Jane Doe" />
                </div>
                <div>
                  <label className="block text-xs uppercase tracking-widest text-gray-500 mb-2">Email Address</label>
                  <input type="email" className="w-full bg-neutral-900 border border-neutral-700 text-white px-4 py-3 focus:outline-none focus:border-red-600 transition-colors" placeholder="jane@example.com" />
                </div>

                {/* Conditional Fields based on booking type */}
                {bookingType === 'group' ? (
                  <div>
                    <label className="block text-xs uppercase tracking-widest text-gray-500 mb-2">Interested Plan</label>
                  ...
                  <div>
                     <label className="block text-xs uppercase tracking-widest text-gray-500 mb-2">Goal / Request</label>
                     <textarea className="w-full bg-neutral-900 border border-neutral-700 text-white px-4 py-3 focus:outline-none focus:border-yellow-600 transition-colors h-24" placeholder="E.g. Preparing for a wedding dance or competition..."></textarea>
                  </div>
                )}

                <button type="button" className={`w-full font-bold uppercase tracking-widest py-4 mt-4 transition-all shadow-lg hover:translate-y-px ${bookingType === 'group' ? 'bg-gradient-to-r from-red-600 to-red-800 text-white hover:shadow-red-900/40' : 'bg-gradient-to-r from-yellow-600 to-yellow-700 text-black hover:shadow-yellow-900/40'}`}>
